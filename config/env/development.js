...
const POSTGRES_PASSWORD=process.env.POSTGRES_PASSWORD || 'strapi'
const POSTGRES_PORT=process.env.POSTGRES_PORT || 5435
const POSTGRES_USER=process.env.POSTGRES_USER || 'strapi'
const POSTGRES_DB=process.env.POSTGRES_DB || 'mvp'
